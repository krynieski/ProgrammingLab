...
#endif
SWIGINTERN int
_wrap_printi(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:printi int ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "printi" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  printi(arg1);
...
SWIGINTERN int
_wrap_printc(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char arg1 ;
  char val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:printc char ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_char SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "printc" "', argument " "1"" of type '" "char""'");
  } 
  arg1 = (char)(val1);
  printc(arg1);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "printi", (swig_wrapper_func) _wrap_printi, NULL},
    { SWIG_prefix "printc", (swig_wrapper_func) _wrap_printc, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Test_SafeInit(Tcl_Interp *interp) {
